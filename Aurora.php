...
<div class="modal fade show" style="display:block"><div class="modal-dialog <?=($act==='edit'||$act==='scan')?'modal-xl':'modal-dialog-centered';?>"><div class="modal-content">
  <?php if($act==='upload'): ?>
    ...
    <form method="post" enctype="multipart/form-data"><div class="modal-body"><input class="form-control" type="file" name="file" required></div><div class="modal-footer glass"><button class="btn btn-secondary" onclick="history.back()">Cancel</button><button class="btn btn-primary" name="upload">Upload</button></div></form>
